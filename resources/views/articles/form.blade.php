                ...
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-sm mb-4 border-0">
                        ...
                        <div class="card-body">
                            ...
                            <input name="seo_title" class="form-control mb-2" placeholder="SEO Title (optional)"
                    ...
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            ...
                            <input name="og_image" class="form-control mb-2" placeholder="OG Image URL (optional)"
