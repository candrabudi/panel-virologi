...
@section('content')
    <div class="col-span-12">
        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
            <div class="text-base font-medium group-[.mode--light]:text-white"> Data Layanan </div>
            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                <a href="/cyber-security-services/create"
                ...
                <div class="flex flex-col gap-y-2 p-5 sm:flex-row sm:items-center">
                    <div>
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Cari layanan..." id="search-input"
...
@push('scripts')
    ...
    <script>
        ...
        function renderServices(products) {
            ...
            products.forEach(product => {
                const statusText = product.is_active ? 'Published' : 'Draft'
                const statusClass = product.is_active ? 'text-success' : 'text-slate-400'

                const categories = product.ai_keywords?.map(cat => `
                ...
                tr.innerHTML = `
                    ...
                    <td class="px-5 border-b dark:border-darkmode-300 relative border-dashed py-3 dark:bg-darkmode-600">
                        <div class="flex items-center justify-center gap-2">
                            <a href="/cyber-security-services/${product.id}/edit"
                                data-tw-merge
        ...
        function loadServices(query = '', page = 1) {
            ...
            axios.get('/cyber-security-services/list', {
                params: {
                    search: currentQuery,
                    page: currentPage,
        ...
        document.getElementById('filter-status')?.addEventListener('change', () => {
            loadServices(currentQuery, 1)
        })

        searchInput?.addEventListener('input', e => {
            clearTimeout(debounceTimer)
            debounceTimer = setTimeout(() => loadServices(e.target.value), 500)
        })
        ...
        function renderPagination(paginator) {
            ...
            const li = (content, page = null, active = false) => `
                <li class="flex-1 sm:flex-initial">
                    <a
                        ${page ? `onclick="loadServices(currentQuery, ${page})"` : ''}
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            axios.delete(`/cyber-security-services/${deleteId}/delete`, {
                headers: {
                ...
                if (res.data.status) {
                    ...
                    showToast(
                        'success',
                        'Berhasil',
                        'Layanan berhasil dihapus. load data terbaru...'
                    )
                    document
