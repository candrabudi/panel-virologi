@extends('layouts.app')
@section('title', 'Add Cyber Security Service')
@section('content')
    ...
    <div class="col-span-12">
        <div class="flex flex-col gap-1 mb-10">
            <div class="flex items-center gap-2">
                <a href="/cyber-security-services" class="p-2 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors group">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 font-medium">Add a professional security offering to your portfolio</p>
                </div>
            </div>
        </div>
        ...
        <form id="service-form" class="grid grid-cols-12 gap-8">
            ...
            <div class="col-span-12 lg:col-span-8 space-y-8 mt-5">
                ...
                <div class="box box--stacked flex flex-col">
                    <div class="px-10 py-6 border-b border-slate-200/60 flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <h3 class="text-lg font-bold text-slate-700">Service Core Information</h3>
                        </div>
                        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-white dark:bg-darkmode-600 px-3 py-1.5 rounded border shadow-sm">Section 01</span>
                    </div>
                    ...
                    <div class="p-10 space-y-8">
                        <div class="grid grid-cols-12 gap-6">
                            <div class="col-span-12 lg:col-span-8">
                                ...
                                <p class="mt-2 text-xs text-slate-400">Gunakan nama lengkap yang deskriptif dan profesional.</p>
                            </div>
                            <div class="col-span-12 lg:col-span-4">
                                <label class="block mb-2 text-sm font-bold text-slate-700">Display Name</label>
                            ...
                            <div class="col-span-12">
                                <label class="block mb-2 text-sm font-bold text-slate-700">Service Category</label>
                                ...
                                <p class="mt-2 text-xs text-slate-400">Tentukan kategori utama untuk filter pada halaman publik.</p>
                            </div>
                            ...
                            <div class="col-span-12">
                                ...
                                <textarea name="summary" rows="3" required
                                    ...
                                    placeholder="Brief overview explaining what value this service provides..."></textarea>
                                <p class="mt-2 text-xs text-slate-400">Ringkasan singkat 1-2 kalimat (muncul pada card listing).</p>
                            </div>

                            <div class="col-span-12">
                                <label class="block mb-3 text-sm font-bold text-slate-700">Detailed Description</label>
                                <div class="rounded-xl overflow-hidden border border-slate-200">
                                    <textarea id="content-editor" name="description" rows="15"
                                        class="form-control w-full border-none shadow-sm"></textarea>
                                </div>
                                <p class="mt-2 text-xs text-slate-400">Gunakan editor ini untuk menjelaskan fitur, keunggulan, dan filosofi layanan secara detail.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-5">
                    ...
                    <div class="box box--stacked p-10 flex flex-col mt-5 hover:border-indigo/30 transition-colors group">
                        ...
                        <button type="button" class="add-repeater-item mt-6 w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border-2 border-dashed border-slate-200 text-slate-500 font-bold text-xs hover:border-indigo/50 hover:bg-indigo/5 hover:text-indigo-600 transition-all" data-target="deliverables-container" data-placeholder="e.g. Monthly Incident Report">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                            Add Deliverable
                        </button>
                    </div>
                    ...
                    <div class="box box--stacked p-10 flex flex-col mt-5 hover:border-emerald/30 transition-colors group">
                        ...
                        <button type="button" class="add-repeater-item mt-6 w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border-2 border-dashed border-slate-200 text-slate-500 font-bold text-xs hover:border-emerald/50 hover:bg-emerald/5 hover:text-emerald-600 transition-all" data-target="target-audience-container" data-placeholder="e.g. Financial Institutions">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                            Add Audience
                        </button>
                    </div>
                    ...
                    <div class="box box--stacked p-10 flex flex-col mt-5 hover:border-amber/30 transition-colors group">
                        <div class="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h4 class="text-base font-bold text-slate-700 uppercase tracking-wider">AI Training Tags</h4>
                                <p class="text-xs text-slate-400 font-medium">Keywords untuk AI Agent</p>
                            </div>
                        </div>
                        <div id="ai-keywords-container" class="space-y-4 flex-1">
                        </div>
                        <button type="button" class="add-repeater-item mt-6 w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border-2 border-dashed border-slate-200 text-slate-500 font-bold text-xs hover:border-amber/50 hover:bg-amber/5 hover:text-amber-600 transition-all" data-target="ai-keywords-container" data-placeholder="e.g. cloud protection">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                            Add AI Keyword
                        </button>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-4 space-y-8">
                ...
                {{-- GUIDANCE BOX --}}
                <div class="bg-gradient-to-br from-primary to-primary/80 rounded-2xl shadow-xl p-7 text-white relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-3 mb-5">
                            <div class="w-10 h-10 bg-white shadow-lg rounded-xl flex items-center justify-center text-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="animate-bounce"><circle cx="12" cy="12" r="10"/><path d="M12 16h.01"/><path d="M12 8v4"/></svg>
                            </div>
                            <h3 class="text-lg font-bold">Quick Guidance</h3>
                        </div>
                        <ul class="space-y-4 text-sm font-medium">
                            <li class="flex gap-3" style="color: #333;">
                                <span class="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center text-[10px] font-bold">1</span>
                                <span>Gunakan <b>Nama Lengkap</b> yang mengandung kata kunci keamanan cyber.</span>
                            </li>
                            <li class="flex gap-3" style="color: #333;">
                                <span class="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center text-[10px] font-bold">2</span>
                                <span><b>Executive Summary</b> adalah teks yang pertama kali dibaca user, buatlah semenarik mungkin.</span>
                            </li>
                            <li class="flex gap-3" style="color: #333;">
                                <span class="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center text-[10px] font-bold">3</span>
                                <span><b>Repeater Fields</b> di sebelah kiri akan tampil sebagai icon list di halaman produk.</span>
                            </li>
                            <li class="flex gap-3" style="color: #333;">
                                <span class="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center text-[10px] font-bold">4</span>
                                <span>Pastikan <b>AI Keywords</b> relevan agar AI Chatbot bisa menyarankan produk ini.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="box box--stacked p-10 flex flex-col mt-5">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center justify-between p-4 rounded-xl border border-slate-100 bg-slate-50/50">
                            <div>
                                <label class="text-sm font-bold text-slate-700 block">Service Status</label>
                                <span class="text-[10px] text-slate-400 font-medium">Muncul di halaman depan</span>
                            </div>
                            <div class="form-check form-switch p-0">
                                <input name="is_active" class="form-check-input scale-125 transition-all shadow-sm" type="checkbox" value="1" checked>
                            </div>
                        </div>
                        <div class="flex items-center justify-between p-4 rounded-xl border border-slate-100 bg-slate-50/50 mt-5">
                            <div>
                                <label class="text-sm font-bold text-slate-700 block">AI Suggestion</label>
                                <span class="text-[10px] text-slate-400 font-medium">Dikenali oleh AI Agent</span>
                            </div>
                            <div class="form-check form-switch p-0">
                                <input name="is_ai_visible" class="form-check-input scale-125 transition-all shadow-sm" type="checkbox" value="1" checked>
                            </div>
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-bold text-slate-700 mt-5">Display Priority</label>
                ...
                {{-- THUMBNAIL --}}
                <div class="box box--stacked p-10 flex flex-col mt-5">
                    <h3 class="text-lg font-bold text-slate-700 mb-6">Visual Assets</h3>
                    <div class="space-y-4">
                        <div class="group relative w-full h-48 bg-slate-50 dark:bg-darkmode-600 rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400 overflow-hidden hover:bg-slate-100 transition-all cursor-pointer">
                            <input type="file" name="thumbnail" accept="image/*" class="absolute inset-0 opacity-0 cursor-pointer z-10" id="thumbnail-input">
                            <div id="thumbnail-preview" class="absolute inset-0 hidden">
                                <img src="" class="w-full h-full object-cover">
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="mb-2 group-hover:scale-110 transition-transform"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>
                            <span class="text-xs font-bold">Drop Image or Click</span>
                        </div>
                        <p class="text-[10px] text-center text-slate-400 font-medium">Recommended: 800x600px | Max 2MB</p>
                    </div>
                </div>

                {{-- ACTION --}}
                <button type="submit" id="btn-save" class="w-full flex items-center justify-center px-8 py-4 text-sm font-bold text-white rounded-2xl bg-primary hover:bg-primary-dark group shadow-xl shadow-primary/30 transition-all active:scale-95 mt-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="mr-3 group-hover:animate-spin-slow"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
...
@push('scripts')
    ...
    <script>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            submitBtn.innerHTML = '<span class="animate-spin mr-3">◌</span> Submitting...';
            ...
            try {
                ...
                showToast('success', 'Perfect!', 'Your new service has been published successfully');
