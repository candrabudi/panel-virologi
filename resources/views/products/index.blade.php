...
@section('content')
    <div class="col-span-12">
        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
            <div class="text-base font-medium group-[.mode--light]:text-white"> Data Produk </div>
...
@push('scripts')
    ...
    <script>
                    ...
                    <td class="px-5 border-b w-80 border-dashed py-4 dark:bg-darkmode-600">
                        <div class="flex items-center">
                            <div class="image-fit zoom-in h-9 w-9">
                                <img src="${getThumbnail(product.thumbnail)}"
        ...
        searchInput?.addEventListener('input', e => {
            ...
            debounceTimer = setTimeout(() => loadProducts(e.target.value), 500)
        })
        ...
        function renderPagination(paginator) {
            ...
            const li = (content, page = null, active = false) => `
                <li class="flex-1 sm:flex-initial">
                    <a
                        ${page ? `onclick="loadProducts(currentQuery, ${page})"` : ''}
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            axios.delete(`/products/${deleteId}/delete`, {
                headers: {
                ...
                if (res.data.status) {
                    ...
                    showToast(
                        'success',
                        'Berhasil',
                        'Produk berhasil dihapus. load data terbaru...'
                    )
                    document
