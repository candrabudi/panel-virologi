...
@section('content')
    <div class="col-span-12">
        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
            <div class="text-base font-medium group-[.mode--light]:text-white"> Data E-Book </div>
            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                <a href="/ebooks/create"
...
@push('scripts')
    ...
    <script>
        ...
        function renderebooks(ebooks) {
            ...
            ebooks.forEach(ebook => {
                const statusText = ebook.is_active ? 'Published' : 'Draft'
                const statusClass = ebook.is_active ? 'text-success' : 'text-slate-400'

                const categories = ebook.ai_keywords?.map(cat => `
                    ...
                    <td class="px-5 border-b w-80 border-dashed py-4 dark:bg-darkmode-600">
                        <div class="flex items-center">
                            <div class="image-fit zoom-in h-9 w-9">
                                <img src="${getThumbnail(ebook.cover_image)}"
        ...
        window.addEventListener('load', loadebooks())
    </script>
    <script>
        function renderPagination(paginator) {
            ...
            const li = (content, page = null, active = false) => `
                <li class="flex-1 sm:flex-initial">
                    <a
                        ${page ? `onclick="loadebooks(currentQuery, ${page})"` : ''}
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            axios.delete(`/ebooks/${deleteId}/delete`, {
                headers: {
                ...
                if (res.data.status) {
                    ...
                    showToast(
                        'success',
                        'Berhasil',
                        'E-Book berhasil dihapus. load data terbaru...'
                    )
                    document
