...
@section('content')
    ...
    <div class="col-span-12">
        ...
        <form id="ajax-form" data-url="{{ route('users.update', $user->id) }}" onsubmit="return false;" autocomplete="off"
            ...
            <div class="col-span-12 lg:col-span-12 space-y-6">
                ...
                <div class="bg-white rounded-lg border border-slate-200 p-6 space-y-6 p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="full_name" value="{{ $user->detail->full_name ?? '' }}"
                            class="transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md form-control"
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    showToast(
                        'success',
                        'Berhasil',
                        response.data.message ?? 'User berhasil diperbarui'
                    )
