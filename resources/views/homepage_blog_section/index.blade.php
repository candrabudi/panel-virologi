    ...
    <div class="col-span-12">
        ...
        <div class="flex flex-col gap-1 mb-8">
            ...
            <p class="text-sm text-slate-500 group-[.mode--light]:text-white/80">
                Kelola judul dan status section Blog & Artikel
            </p>
        </div>
                    ...
                    <form id="blog-section-form">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div class="space-y-8 p-5">
                                ...
                                <div class="space-y-6">
                                    <div class="rounded-md border p-4 bg-slate-50 dark:bg-darkmode-700">
                                        <h3 id="pv-title" class="text-lg font-semibold">
                                            Blog & Artikel
                                        </h3>
                                        <p id="pv-subtitle" class="text-sm text-slate-500 mt-1">
                                            Sub judul section blog
                                        </p>

                                        <span id="pv-status" class="inline-block mt-3 badge bg-secondary">
                                            NONAKTIF
                                        </span>
                                    </div>
                        ...
                        <div class="flex justify-end pt-8 mt-10 border-t border-slate-200/70">
                            <button type="button" id="btn-save"
                                ...
                                <span class="btn-text">Simpan Blog Section</span>
                            </button>
                        </div>
        ...
        async function loadSection() {
            try {
                ...
                showToast(
                    'danger',
                    'Gagal',
                    'Tidak dapat memuat data Blog Section'
                )
            }
        }
        ...
        btn.onclick = async () => {
            ...
            try {
                ...
                showToast(
                    'success',
                    'Berhasil',
                    res.data.message || 'Blog section berhasil disimpan'
                )
            } catch (e) {
